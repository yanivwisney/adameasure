...
class Crop(Base):
    ...
    best_planting_seasons = Column(JSON, nullable=True)  # List of months for optimal planting
    ...
    harvest_window_days = Column(Integer, nullable=True)  # How long harvest can be delayed
    
    # Additional metadata
    sun_requirements = Column(String(50), nullable=True)  # full_sun, partial_shade, etc.
